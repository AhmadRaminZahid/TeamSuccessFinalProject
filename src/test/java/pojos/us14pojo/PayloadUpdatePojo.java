package pojos.us14pojo;

import java.util.List;
import java.io.Serializable;

public class PayloadUpdatePojo implements Serializable {
	...
	public PayloadUpdatePojo() {
	}

	public PayloadUpdatePojo(String birthDay, String birthPlace, String email, String gender, boolean isAdvisorTeacher, List<Integer> lessonsIdList, String name, String password, String phoneNumber, String ssn, String surname, String username) {
